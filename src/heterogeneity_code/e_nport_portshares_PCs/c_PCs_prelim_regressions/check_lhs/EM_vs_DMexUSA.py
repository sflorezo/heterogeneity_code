...
from heterogeneity_code.e_nport_portshares_PCs.b_check_PCs.a_preliminary.a_merge_PCs_and_funds import fetch_PCs_with_fund_info
...
def _build_fund_panel_collapsed_by_EM_DM_holdings():
    ...
    from pysfo import paralell_utils
    from heterogeneity_code.e_nport_portshares_PCs.c_PCs_prelim_regressions.b_make_regressions import _collapse_debt_holdings_EM_DM_USA
